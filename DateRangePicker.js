...
import {Calendar, CalendarList, defaultStyle} from 'react-native-calendars';
...
export default class DateRangePicker extends Component {
  ...
  onDayPress = day => {
    console.log(this.state.isFromDatePicked);
    console.log(this.state.isToDatePicked);
        ...
        for (var i = 1; i <= range; i++) {
          ...
          if (i < range) {
            markedDates[tempDate] = {
              color: this.props.theme.markColor2,
              textColor: this.props.theme.markTextColor,
            };
          } else {
            markedDates[tempDate] = {
